...
def test_get_excluded_variables():
    ...
    actual_output = spl3fta_varinfo.get_excluded_science_variables()
    assert expected_output == actual_output


def test_is_excluded_science_variable():
    ...
    assert spl3fta_varinfo.is_excluded_science_variable(
        '/Freeze_Thaw_Retrieval_Data/thaw_reference_date'
    )
    assert spl3fta_varinfo.is_excluded_science_variable(
        '/Freeze_Thaw_Retrieval_Data/freeze_thaw_time_utc'
    ...
    assert not spl3fta_varinfo.is_excluded_science_variable(
